...
- 도구: `[TOOL-24]` lineage-tree(`npm run tree`) · `[TOOL-25]` dashboard v2.2(개요 전체 유지 + 축 페이지: **당위·스프린트**,
...
- 테스트 **34스위트 중 32 통과 · 2 실패**(`leakage-guard`·`ref-linter` — 미커밋 fdt 귀속).
  신규: `query.test.js` 39단언 · `dashboard.test.js` 88단언(당위 14 + 스프린트 15 + 라우팅·개요 보존) · `health.test.js` 33단언 ·
